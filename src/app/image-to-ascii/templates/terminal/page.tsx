    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Start with one of our free Terminal templates and customize it using the Image To Ascii.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Our Terminal templates are designed to give you a head start. Combine them with the raw power of our client-side generator to produce stunning results in seconds.
        </p>
      </div>
    </div>
  );
