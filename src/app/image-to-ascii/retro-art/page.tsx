...
export const metadata = constructMetadata({
  title: "Retro ascii art generator | ASCII Art Generator",
  description: "Create amazing retro ascii art generator using our free online Image To Ascii generator. Fast, secure, and runs entirely in your browser.",
  path: "/image-to-ascii/retro-art",
});
    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 capitalize">
          retro ascii art generator Generator
        </h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Create amazing <strong>retro ascii art generator</strong> using our free online tool. It&apos;s fast, secure, and completely client-side.
        </p>
      </div>

      <div className="bg-muted/30 border border-muted-foreground/20 rounded-xl p-8 mb-12 text-center">
        <h2 className="text-2xl font-bold mb-4">Ready to create your retro ascii art generator?</h2>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h2>How to make a retro ascii art generator</h2>
        <p>
          Making a retro ascii art generator has never been easier. With our <strong><Link href="/image-to-ascii">Image To Ascii</Link></strong>,
        ...
        <div className="mt-6 space-y-6">
          <div>
            <h3 className="text-lg font-bold">Is this retro ascii art generator generator free?</h3>
