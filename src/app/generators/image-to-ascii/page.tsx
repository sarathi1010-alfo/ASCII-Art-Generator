...
const faqItems = [
  ...
  {
    question: "Can I download the ASCII output?",
    answer: "Yes, you can copy the text to your clipboard or download it as a .txt file. Some generators also allow you to save the output as an image."
  }
];
