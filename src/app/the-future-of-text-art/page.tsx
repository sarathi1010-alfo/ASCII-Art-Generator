...
export const metadata = resolveMetadata(buildProductMeta({
  title: "The Future Of Text Art | Free Online Generator",
  description: "Use our free online The Future Of Text Art. Fast, secure, and runs entirely in your browser.",
  slug: "/the-future-of-text-art",
}));
    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      ...
      <div className="bg-muted/30 border border-muted-foreground/20 rounded-xl p-8 mb-12 text-center">
        ...
        <p className="mb-6 text-muted-foreground">
          The The Future Of Text Art interface is currently being built. Check back soon!
        </p>
        <Link href="/">
