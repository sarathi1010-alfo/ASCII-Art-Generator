...
export const metadata = constructMetadata({
  title: "Text To Ascii vs Patorjk | Best Free Alternative",
  description: "Comparing Text To Ascii with Patorjk. Find out why our free, client-side browser utility is the better choice.",
  path: "/text-to-ascii/vs/patorjk",
});
    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Looking for a better alternative to Patorjk? See why our completely free, client-side tool is the right choice.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          When comparing <strong>Text To Ascii</strong> to <strong>Patorjk</strong>, the most important factor is privacy and speed.
        </p>
        <ul>
